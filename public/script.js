(function () {
  ...
  function entryHtml() {
    ...
    return (
      ...
      "</div>" +
      '<div class="card">' +
        '<div class="card-eyebrow"><span>New Entry</span><span>' + todayStamp() + "</span></div>" +
  ...
  function explanationHtml() {
    ...
    var concepts = ex.keyConcepts || [];
    var open = concepts[state.openConcept];
    return (
      '<div class="card">' +
        ...
        (concepts.length
          ? '<div class="section-heading">Key concepts</div>' +
            ...
            concepts.map(function (c, i) {
              return '<button class="concept-tab ' + (i === state.openConcept ? "is-open" : "") +
                '" data-action="open-concept" data-index="' + i + '">' + escapeHtml(c.name) + "</button>";
            }).join("") +
            "</div>" +
            (open ? '<div class="concept-detail card-body"><p>' + escapeHtml(open.explanation) + "</p></div>" : "")
          : "") +
  ...
  function examHtml() {
    ...
    return (
      '<div class="exam-progress">' +
        '<span class="exam-counter">CARD ' + (i + 1) + " / " + qs.length + "</span>" +
  ...
  function resultsHtml() {
    ...
    return (
      '<div class="card">' +
        ...
        '<div class="score-stamp ' + scoreClass + '">' + score + "%</div>" +
        ...
        '<div class="concept-grid">' + concepts.map(function (c) {
          ...
          return '<div class="concept-row"><span class="concept-name">' + escapeHtml(c.tag) + '</span>' +
            '<span class="tag-stamp filed">Filed \u2014 mastered</span></div>';
        }).join("") + "</div>" +
  ...
  document.addEventListener("click", function (e) {
    ...
    switch (action) {
      ...
      case "open-concept":
        state.openConcept = Number(el.dataset.index);
        render();
        break;
